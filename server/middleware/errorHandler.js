...
exports = module.exports = function errorHandler(options) {
    ...
    if(opts.errorHTML === undefined) {
        throw new TypeError('option.errorHTML must specified in the middleware definition');
    }

    var errorHTML = opts.errorHTML;
    ...
    return function errorHandler(err, req, res, next) {
        ...
        // html
        if (type === 'html') {
            fs.readFile(errorHTML, 'utf8', function (e, html) {
                if (e) return next(e);
            ...
            var error = (env === 'production') ? { status: err.status, message: err.message } : { status: err.status, message: err.message, stack: err.stack };
